    ...
    return (
        <div className='item mt-5'>
            ...
            <div className='rounded-[50%] w-[60px] h-[50px] overflow-hidden'>
                ...
                <input onFocus={props.onOpenCreatePost} className='p-3 w-full outline-none border-b border-[#ccc]' type="text" name="" id="" placeholder={`Bạn đang nghĩ gì vậy ${currentUser.name}?`} />
