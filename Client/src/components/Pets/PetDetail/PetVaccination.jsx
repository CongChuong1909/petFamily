...
function PetVaccination(props) {
    ...
    const petFetch = useQuery({
        queryKey: ["vaccination", petId],
        queryFn: async () => {
            const res = await makeRequest.get(`/petdetail/vaccination/${petId}`);
            return res.data;
        },
        });
    ...
    const mutationAdd = useMutation(
        (newItem)=>{
        return makeRequest.post("/petdetail/add/vaccination", newItem)
        },{
        onSuccess:()=>{
    ...
    const mutationDelete = useMutation(
        (id)=>{
            return makeRequest.delete(`/petDetail/delete/vaccination/${id}`)
        },
        {
            onSuccess:()=>{
                queryClient.invalidateQueries(["vaccination"])
    ...
    return (
        <div>
            ...
            <div className="flex justify-between">
                ...
                <img className="w-[32px]" src="https://bluecare.vn/images/categories/139401550749157.png" alt="" />
