            ...
            <div className='relative'>
                <div className='flex justify-center items-center'>
                    <div className='flex w-[30%] justify-center flex-col items-center'>
                        ...
                        <img className='w-28' src={infoPet.kind === 'dog'? `https://cdn2.thedogapi.com/images/${infoPet.reference_image_id}.jpg` : `https://cdn2.thecatapi.com/images/${infoPet.reference_image_id}.jpg`}  alt="" />
                    ...
                    </div>
                    {
                        ...
                        <>
                            ...
                            <div className='flex w-[30%] justify-center flex-col items-center'>
                                {/* src={infoPet.kind === 'dog'? infoPet.image.url : `https://cdn2.thecatapi.com/images/${infoPet.reference_image_id}.jpg`} */}
                                <img className='w-28' src={crossbred.kind === 'dog'? `https://cdn2.thedogapi.com/images/${infoPet.reference_image_id}.jpg` : `https://cdn2.thecatapi.com/images/${crossbred.reference_image_id}.jpg`}  alt="" />
